...
namespace PeliculasAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Servicio para guardar imagenes en Azure
            //services.AddTransient<IAlmacenadorArchivos, AlmacenadorAzureStorage>();
            //Servicios para guardar imagenes y archivos en mi BD local
...
//En mi metodo ConfigureServices() configuro todos mis servicios:
//mi servicio Controllers
//mi servicio AutoMapper
//mi servicio DbContext
//mi servicio Azure
//mi servicio Authentication
//etc..

//En mi metodo Configure() ejecuto todos los middleware de mi app
